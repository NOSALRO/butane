...
int main(int argc, char** argv)
{
    ...
    // quantizer->affine_transform()->set_momentum(.5);
    ...
    auto c_enc_out = c_enc->output_size();
    butane::nn::ConvUpsampleBlockOptions co_dec{
        .input_dims = {c_enc_out[0].item<int>(), c_enc_out[1].item<int>(), c_enc_out[2].item<int>()},
        .channels = {32, 1},
    ...
    butane::nn::ConvUpsample2dBlock<torch::nn::BatchNorm2d, torch::nn::MaxPool2d> c_dec(co_dec);
