...
if __name__ == "__main__":
    ...
    model = butane.nn.UNet2d([1, 28, 28], 32, channel_mults=(1, 2, 4), self_condition=True, attention=True, use_film=True).to(dev)
    ...
    sampled = fm.flow(model, x0=torch.randn(cond.size(0), 1, 28, 28), n_timesteps=100, condition=cond).squeeze().cpu()
